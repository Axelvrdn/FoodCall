...
export function Grainient({
  ...
  useEffect(() => {
    ...
    if (typeof ResizeObserver !== 'function' || typeof IntersectionObserver !== 'function') return;
    if (!canCreateWebGL2Context()) return;
    ...
    canvas.setAttribute('data-testid', 'grainient-canvas');
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uWarpStrength: { value: 2.15 },
        uWarpFrequency: { value: 5 },
        uWarpSpeed: { value: 3.9 },
        uWarpAmplitude: { value: 73 },
        uBlendAngle: { value: 0 },
