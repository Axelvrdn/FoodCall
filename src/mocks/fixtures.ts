...
export const inviteFixtures: GroupInvite[] = [
  { id: 'invite-lille', groupId: 'group-lille', code: 'FCLILLE1', expiresAt: '2026-06-01T10:00:00.000Z', maxUses: 12, currentUses: 4, createdAt: '2026-04-02T10:00:00.000Z' },
  { id: 'invite-paris', groupId: 'group-paris', code: 'FCPARIS1', expiresAt: '2026-06-10T08:00:00.000Z', maxUses: 8, currentUses: 3, createdAt: '2026-04-10T08:00:00.000Z' },
  { id: 'invite-lyon', groupId: 'group-lyon', code: 'FCLYON01', expiresAt: '2026-06-20T09:00:00.000Z', maxUses: 10, currentUses: 2, createdAt: '2026-04-20T09:00:00.000Z' },
];

// ── Restaurants ──────────────────────────────────────────────────────────
export const restaurantFixtures: Restaurant[] = [
  { id: 'rest-kebab', name: 'Lille Kebab Express', description: 'Rapide et généreux.', address: '12 Rue de Béthune, Lille', latitude: '50.632000', longitude: '3.060000', cuisineTags: ['fast-food', 'kebab'], photoUrls: [], phone: null, website: null, createdBy: 'user-alice', createdAt: '2026-04-03T10:00:00.000Z', distanceMeters: 250 },
  { id: 'rest-bistrot', name: 'Le Petit Bistrot Lillois', description: 'Croisement de tradition et convivialité.', address: '45 Rue de la Monnaie, Lille', latitude: '50.628000', longitude: '3.055000', cuisineTags: ['french', 'bistro'], photoUrls: [], phone: null, website: null, createdBy: 'user-alice', createdAt: '2026-04-03T10:05:00.000Z', distanceMeters: 380 },
  { id: 'rest-marcel', name: 'Chez Marcel Sandwich', description: 'Sandwichs sans prétention.', address: '8 Rue du Curé Saint-Étienne, Lille', latitude: '50.630000', longitude: '3.058000', cuisineTags: ['fast-food', 'sandwich'], photoUrls: [], phone: null, website: null, createdBy: 'user-ben', createdAt: '2026-04-04T10:00:00.000Z', distanceMeters: 450, rating: { average: 1.33, count: 3 } },
  { id: 'rest-table', name: 'La Table de Lille', description: 'Gastronomie fine du Nord.', address: '20 Rue de Paris, Lille', latitude: '50.631000', longitude: '3.054000', cuisineTags: ['french', 'fine-dining'], photoUrls: [], phone: null, website: null, createdBy: 'user-alice', createdAt: '2026-04-03T10:10:00.000Z', distanceMeters: 520 },
